          ...
          <TabsContent value="lab-reports" className="mt-6">
            <div className="space-y-6">
              <div className="flex justify-between items-center">
                <h3 className="text-xl font-semibold">Lab Reports Management</h3>
                <Dialog>
                  ...
                  <DialogContent className="max-w-md">
                    <DialogHeader>
                      ...
                      <DialogDescription>Upload a new lab report with patient details</DialogDescription>
                    </DialogHeader>
                    <div className="space-y-4">
                      <div>
                        <Label htmlFor="patient-nic">Patient NIC</Label>
                        <Input id="patient-nic" placeholder="Enter patient NIC number" />
                      </div>
                      <div>
                        <Label htmlFor="patient-name-report">Patient Name</Label>
                        <Input id="patient-name-report" placeholder="Enter patient name" />
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <Textarea id="report-notes" placeholder="Enter any additional notes or observations" />
                      </div>
                      <div>
                        <Label htmlFor="report-file">Upload Report File</Label>
                        <Input id="report-file" type="file" accept=".pdf,.jpg,.png,.jpeg" />
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-green-600">
                          {labReports.filter(r => r.status === "Completed" && r.date === "2024-01-20").length}
                        </p>
                      </div>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Overview of all laboratory reports</CardDescription>
                </CardHeader>
