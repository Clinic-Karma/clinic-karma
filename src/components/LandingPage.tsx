...
const LandingPage = () => {
  ...
  const stats = [
    { label: "Active Patients", value: "12,458", growth: "+15%" },
    { label: "Expert Doctors", value: "245", growth: "+8%" },
    { label: "Appointments Completed", value: "89,234", growth: "+22%" },
    { label: "Patient Satisfaction", value: "98.5%", growth: "+2%" }
  ];
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {doctors.map((doctor, index) => (
              <Card key={index} className="shadow-card hover:shadow-lg transition-all duration-300 group overflow-hidden">
